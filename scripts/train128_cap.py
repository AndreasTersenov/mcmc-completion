"""Phase 1b conditional CAPACITY ARM (fired by the frozen rule: STRUCTURAL with
plateau before 1M — log/2026-07-11-phase1b.md). ONE run: 2x encoder+head width
(enc_dim 256, enc_hidden 512, head (512,512,512); attn-2 and everything else
IDENTICAL to the 2M line: dataset jr.key(3131), T-mix, aux, init jr.key(32),
fold_in(jr.key(33), i), BATCH 512, LR 1e-3), 1M steps, cosine to 1M.
Milestones 0.25/0.5/1M. Resumable. ICS_SMOKE=1 = CPU path test only."""
...
STEPS_TOTAL, BATCH, LR = 1_000_000, 512, 1e-3
